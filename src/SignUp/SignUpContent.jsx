            ...
            <div className="w-1/2 flex justify-center items-center p-8 lg:p-12">
                <div className="max-w-md w-full">
                    <div className="w-full py-4 lg:py-6 font-semibold text-center text-xl lg:text-2xl">
                        Join & Connect the Fastest Growing Online <span className="text-red-600">Community</span>
                    </div>
                    <div className="flex justify-center mt-4 mb-6">
                        ...
                        <button className="mx-2 px-4 py-2 bg-white border border-gray-300 rounded-full flex items-center">
                            <img src="path/to/github-icon.png" alt="Github" className="w-5 h-5 mr-2" /> Sign up with Github
                        </button>
                    </div>
                    ...
                    <div className="text-center mt-4">
                        <p>Own an Account? <Link to='/' className="text-red-600 font-semibold">JUMP RIGHT IN</Link></p>
                    </div>
                </div>
            </div>
        </div>
